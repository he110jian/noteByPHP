...
echo '<div id="leaveMSG" style="position: absolute; top: 0px; width: 50%;" class="text-right"><a class="btn btn-success" data-toggle="modal" data-target="#myModal">Leave A Message</a></div>';
if($message_count!=0)
{
