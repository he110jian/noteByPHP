            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    if(msg.update===-1)
                    {
                        ...
                        var new = "<div class='panel panel-default' id='"+msg.time+"'><div class='panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-toggle='collapse' data-parent='#accordion' href='#collapse"+i+"'><span  class='glyphicon glyphicon-circle-arrow-right'></span><span id='title"+i+"'> "+mesg.titile+"</span><small class='pull-right text-muted'>"+mag.time+"</small></a></h4></div><div id='collapse"+i+"' class='panel-collapse collapse'><div class='panel-body'><p id='msg"+i+"'>"+msg.content+"</p><hr/><p class='text-center'><a href='javascript:void(0);' onclick='edit("+i+")' class='pull-left text-info'><span class='glyphicon glyphicon-edit'></span></a><a class='pull-right text-danger' href='javascript:void(0);' onclick='return delcfm("+msg.time+");><span class='glyphicon glyphicon-remove'></span></a></p></div></div></div>";
